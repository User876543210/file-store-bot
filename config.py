...
ADMINS = int(environ.get("ADMINS", "6567496381"))
...
# Bot Information
BOT_TOKEN = environ.get("BOT_TOKEN", "7049079885:AAEupj8RJaY34gTNrZ0_sneIdkPWvroAk9I")
BOT_USERNAME = environ.get("BOT_USERNAME", "Asflimbot") # your bot username without @
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002172653271')).split()]
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002155379493'))
    ...
    if HAS_SSL:
        URL = "troubled-tabbatha-akasuflim2-9db095f1.koyeb.app/"
    else:
        URL = "troubled-tabbatha-akasuflim2-9db095f1.koyeb.app/"
